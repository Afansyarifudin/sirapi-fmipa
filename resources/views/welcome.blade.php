...
<body>
    ...
    <div class="top-wrapper text-center" style="background-image: url(assets/images/bgarsip.jpeg); background-size: cover; background-opacity : 0.2; padding: 195px 0 180px 0; oacity: 0.2">
        <div class="container">
